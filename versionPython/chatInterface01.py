# Código das funcionalidades de consulta dos embeddings - Interface v1
...
def chatgpt_clone(message, history):
    response=answer_question(question = message, debug=False)
    curretninteration = {
        "question": message,
        "response": response.content
    }
    history.append(curretninteration)
    output = {
...
def main():
    demo = gr.Interface(fn=chatgpt_clone, 
